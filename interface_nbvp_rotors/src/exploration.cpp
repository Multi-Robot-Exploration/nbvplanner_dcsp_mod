...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    ros::Publisher trajectory_pub = nh.advertise<trajectory_msgs::MultiDOFJointTrajectory>(mav_msgs::default_topics::COMMAND_TRAJECTORY, 5);
    ...
    ROS_INFO("initial motion is over. navigation can start now");
